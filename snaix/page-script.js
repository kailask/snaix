...
var highScore;
var clickFX = new Audio("assets/click.wav");
var music = [new Audio("assets/music.mp3")];//possible music
var currentMusicIndex;//the index of the current music the the music array
var deathAudio = new Audio("assets/endNoise.wav");
var whoosh = new Audio("assets/whoosh.wav");
...
var newBodySound = new Audio("assets/newBody.wav");
var addBodySound = new Audio("assets/addBody.wav");
var otherWhoosh = new Audio("assets/otherWhoosh.wav");
var powerUpSound = new Audio("assets/powerup.wav");
var powerUpCount = 0;
var powerUp = 0;
// var menuMusic = new Audio("assets/menumusic.wav");
var powerDownSound = new Audio("assets/powerdown.wav");
var reverseSound = new Audio("assets/reversesound.wav");
